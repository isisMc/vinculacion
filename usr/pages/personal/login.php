...
<body>
    ...
    <div class="container">
        ...
        <div class="curved-shaped">
        </div>

        <div class="form-box Login">
        <div class="button-header">
  <a href="#" class="btn-admin active">Estudiante</a>
  <a href="../../../adm/pages/personal/login.php" class="btn-nav">Administrador</a>
  <a href="../../../guess/guess.php" class="btn-nav">Invitado</a>
</div>

            <h2 class="txt mt-5">COMIENZA TU CAMINO PROFESIONAL</h2>
            <form id="form">
                <div class="input-box">
                    <input type="text" id="curp" name="curp"
                        pattern="[A-Z]{4}[0-9]{6}([A-Z]{3, 4}[1-9]|[A-Z]{2}[1-9]{2})" minlength="18" maxlength="18"
                        required>
                    <label for="">CURP</label>
                    <i class="fa fa-id-card"></i>
                </div>
                <div class="input-box">
                    <input type="text" id="noctrl" name="noctrl" minlength="14" maxlength="14" pattern="[0-9]{14}"
                        required>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body d-flex align-items-center">
                    <div class="row">
                        <div class="col-5">
                            <img src="../../dist/img/notfound.jpg" class="rounded-pill mb-3" alt="Usuario no encontrado"
